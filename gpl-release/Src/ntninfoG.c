 ...
 *
 * Originally Copyright (C) 1989 Martin Forssen <maf@recordedfuture.com>
 ...
 *
 * Historical Notes:
 * - Original version written by Martin Forssen
 * - Later rewritten by Adam Bryant for new data structures
 * 
